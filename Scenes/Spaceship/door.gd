...
@onready var skip_progress: TextureProgressBar = $ConfirmationCanvasLayer/SkipProgress
...
func start():
	...
	waiting_input = true
	PopUpSystem.show_text("Segure CONFIRME para sair da nave e iniciar um novo dia.", 2)
...
func _process(delta: float) -> void:
	...
	var holding: bool = Input.is_action_pressed("confirm")
